...
console.log(sumaAB)
console.log(diferentaAB)
console.log(inmultireAB)
console.log(impartireAB)


// Ex 4) Extra - sa se afiseze in consola lungimea string-ului de la exercitiul 1. De exemplu, daca nunele userului curent este "Cristian" sa se afiseze in consola
let lungimeText = userId.length;
